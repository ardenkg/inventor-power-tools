# Coloring Tool Add-in for Autodesk Inventor 2026

A face coloring tool for Autodesk Inventor 2026 that lets you select faces using intelligent topology-based filters and apply any color to them using Inventor's appearance system.
...
1. Build the project:
   ...
   ```
2. Copy `ColoringTool.dll` and `ColoringTool.addin` to one of the following:
   - **User:** `%APPDATA%\Autodesk\Inventor 2026\Addins\ColoringTool\`
...
├── ColoringTool.csproj                 # Project file (.NET 8.0)
├── Core/
