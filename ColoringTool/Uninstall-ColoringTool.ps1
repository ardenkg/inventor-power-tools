<#
.SYNOPSIS
    Uninstalls the ColoringTool Add-in for Autodesk Inventor 2026.

.DESCRIPTION
    This script removes the ColoringTool Add-in files from the Inventor Add-ins folder.
...
.EXAMPLE
    .\Uninstall-ColoringTool.ps1
    
.EXAMPLE
    .\Uninstall-ColoringTool.ps1 -UninstallScope All
...
$UserAddinsFolder = Join-Path $env:APPDATA 'Autodesk\Inventor 2026\Addins\ColoringTool'
$MachineAddinsFolder = 'C:\ProgramData\Autodesk\Inventor Addins\ColoringTool'

# Banner
Write-Host ""
Write-Host "================================================" -ForegroundColor Cyan
Write-Host "  ColoringTool Add-in Uninstaller" -ForegroundColor Cyan
...
if ($removedCount -gt 0) {
    ...
    Write-Host "================================================" -ForegroundColor Yellow
    Write-Host ""
    Write-Host "The ColoringTool add-in was not found in the specified location(s)." -ForegroundColor Gray
}
