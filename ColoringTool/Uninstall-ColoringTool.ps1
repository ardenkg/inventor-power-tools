<#
.SYNOPSIS
    Uninstalls the ColoringTool Add-in for Autodesk Inventor (2022-2026).

.DESCRIPTION
    Removes ColoringTool from all detected Inventor Add-ins folders.
