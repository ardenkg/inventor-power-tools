<#
.SYNOPSIS
    Installs the iNode Add-in for Autodesk Inventor (2022-2026).

.DESCRIPTION
    This script builds the iNode project and copies the necessary files
...
.EXAMPLE
    .\Install-iNode.ps1 -InstallScope Machine -Configuration Debug
#>
...
Write-Host "  Visual Parametric Editor for Inventor" -ForegroundColor Cyan
Write-Host "================================================" -ForegroundColor Cyan
Write-Host ""

# Check for admin if machine scope
...
foreach ($ver in $InstalledVersions) {
    ...
    $filesToCopy += "Newtonsoft.Json.dll"
...
Write-Host "  4. Click the 'iNode Editor' button"
Write-Host ""
Write-Host "To uninstall, run: .\Uninstall-iNode.ps1" -ForegroundColor Gray
Write-Host ""
