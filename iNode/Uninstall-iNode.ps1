<#
.SYNOPSIS
    Uninstalls the iNode Add-in for Autodesk Inventor.

.DESCRIPTION
    Removes all iNode add-in files from the Inventor Add-ins folders.
...
.EXAMPLE
    .\Uninstall-iNode.ps1 -UninstallScope All
#>
...
$InventorYears = @('2022', '2023', '2024', '2025', '2026')
